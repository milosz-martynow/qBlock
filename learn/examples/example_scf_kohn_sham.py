...
from compute.environment.configuration import Configuration
...
from compute.models.initialization import RKS
...
OUTPUT_DIR = (
    Path(__file__).resolve().parent / f"output_{Path(__file__).stem}"
)
...
CONFIG_PATH = (
    Path(__file__).resolve().parent / ".qblock.config.example"
)
