...
class BasisSet:
    ...
    def __getitem__(self, key: Union[str, int]) -> Regions:
        ...
        :param key: Atomic symbol (e.g. ``"H"``, ``"O"``) **or**
            ...
            :data:`~compute.environment.constants.natural.atoms_data.ATOMS_SYMBOLS_Z_TO_SYMBOL`.
...
class Pople(BasisSet):
    ...
    * **Polarization and diffuse** (6-311ppGss, etc.): Extended split-valence
    ...
    Example
    -------
    >>> basis = Pople("q_block/compute/environment/constants/numerical/basis_set/pople/3-21G.gbs")
