...
class InputData:
    ...
    input readers (:mod:`compute.input_data`) and higher-level containers
    such as :class:`compute.atomic_system.AtomicSystem`.
    ...
    def from_script(
        ...
        :class:`~compute.io.basis_set.BasisSet` instance to attach to
        the :class:`~compute.models.atom.Atom`.  An optional sixth
