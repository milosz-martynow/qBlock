...
for molecular systems that extends :class:`compute.atomic_system.AtomicSystem`.
"""
...
from q_block.compute.models.atom import Atom
...
from q_block.compute.models.electron import SubShell
...
class Molecule(AtomicSystem):
    ...
    A :class:`~compute.io.basis_set.BasisSet` instance (e.g.
    :class:`~compute.io.basis_set.Pople`) can be passed to the
    ...
    def n_electrons(self) -> int:
        ...
        Each :class:`~compute.models.atom.Atom` already accounts for
    ...
    def to_bohr(self) -> None:
        ...
        :raises TypeError: If any atom's coordinates are not of type
            :class:`~compute.io.coordinates.CartesianCoordinates`.
        """
    ...
    def populate_spinorbitals_with_gto(self) -> None:
        ...
        Atoms without an associated :class:`~compute.io.basis_set.BasisSet`
