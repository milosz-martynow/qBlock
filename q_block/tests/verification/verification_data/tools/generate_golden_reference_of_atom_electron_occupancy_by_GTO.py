...
from q_block.tests.verification.models.test_atom import _serialize_atom_for_test
...
BASIS_ROOT: Path = Path(
    "./q_block/compute/environment/constants/numerical/basis_set/gto_gaussian_format"
)

GOLDEN_ROOT: Path = Path("./tests/verification/verification_data/gto_population")
