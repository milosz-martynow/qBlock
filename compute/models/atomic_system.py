...
The class stores atoms via an :class:`compute.input_data.InputData`
instance, which itself wraps the canonical :class:`pandas.DataFrame` with
atom metadata and attached :class:`compute.atom.Atom` instances.
"""
...
class AtomicSystem:
    ...
    This class stores atom metadata and attached :class:`compute.atom.Atom`
    instances using an :class:`compute.input_data.InputData` object.
    ...
    per-atom :attr:`~compute.models.atom.Atom.charge` values.
    ...
    def charge(self) -> int:
        ...
        Computed as the sum of :attr:`~compute.models.atom.Atom.charge`
