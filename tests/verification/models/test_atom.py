"""Unit tests for compute.models.atom module.
...
from tests.verification.environment.constants import (
    BASIS_FILES,
    BASIS_ROOT,
    CHARGE_VALUES,
    GOLDEN_ROOT,
...
from tests.verification.verification_data.expected_atom_pure import EXPECTED_ATOM_PURE
