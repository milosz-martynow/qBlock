...
from tests.verification.utilities import h2_molecule, water_molecule
...
def test_h2_nuclear_repulsion(h2_molecule: Molecule) -> None:
    ...
    :param h2_molecule: H2 molecule fixture from tests.verification.utilities.
...
def test_water_nuclear_repulsion(water_molecule: Molecule) -> None:
    ...
    :param water_molecule: Water molecule fixture from tests.verification.utilities.
