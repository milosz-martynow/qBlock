...
#   "proposed_approach":  List[str]   – applicable methods; any subset of
#                                       ["RHF", "ROHF", "UHF", "RKS", "UKS"]
#   "energies": {
...
#                           "note": str, "level": int}],
#   }
#   "proposed_basis_set": str  – path to the Gaussian basis set file
