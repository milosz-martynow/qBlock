"""Unit tests for q_block.theory.initialization.nuclear_repulsion_energy module.
...
def test_scaling_with_nuclear_charge(Z_pair: Tuple[int, int], expected_ratio: float) -> None:
